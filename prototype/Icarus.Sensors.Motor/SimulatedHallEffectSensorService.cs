...
{
    public class SimulatedHallEffectSensorService : IHallEffectSensorService
    {
        ...
        public SimulatedHallEffectSensorService(IMotorController motorController, ITiltSensor tiltSensor)
        {
        ...
        public int GetWheelRpm(WheelLocation wheel)
        {
            ...
            var rpm = ConvertPwmToRpm(wheel == WheelLocation.Left ? _motorController.GetLeft() : _motorController.GetRight());
